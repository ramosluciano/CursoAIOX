...
3:T498c,# Aula 12 — Dev: Normalização, API e Persistência
...
> - [ ] Decomposição é por campo (não por fonte)?
> - [ ] Cada campo lista as variações conhecidas (dos insights da Memory Layer)?
> - [ ] Há subtask de validação do registro completo?
> - [ ] Há tratamento para campos ausentes? (null, flag, rejeição?)
> - [ ] Há conceito de "completeness score"? (quantos campos foram preenchidos)
...
> - [ ] Aceita output de qualquer layer sem erro?
> - [ ] Placa está padronizada? (mesmo formato independente da fonte)
> - [ ] Valor é numérico? (não string com "R$")
> - [ ] Data está em formato ISO? (YYYY-MM-DD)
> - [ ] Campos ausentes são tratados (null, não string vazia)?
> - [ ] Registro tem completeness score? (ex: 10/12 campos preenchidos)
...
> - [ ] PDF corrompido: não crasha — retorna erro claro com motivo?
> - [ ] URL inválida: tenta outras layers antes de desistir?
> - [ ] Extração parcial: salvou os registros bons? Reportou os problemáticos?
> - [ ] Normalização parcial: registro salvo com campos disponíveis + flag?
> - [ ] Falha total: fonte registrada em fila de retry?
> - [ ] Logs: cada falha e recovery está logado com contexto suficiente para debug?
...
> - [ ] Pipeline end-to-end funciona? (PDF → banco → API retorna dados)
> - [ ] Dados no banco estão normalizados? (formato unificado)
> - [ ] Metadata está presente? (fonte, layer, data, completeness)
> - [ ] Filtros da API funcionam? (marca, modelo, valor, cidade)
> - [ ] Status endpoint mostra métricas reais do pipeline?
> - [ ] Registros parciais estão no banco com flag correto?
...
> - [ ] O QA testou com dados problemáticos (não apenas happy path)?
> - [ ] Há issues sobre o Recovery System?
> - [ ] Há issues sobre deduplicação?
> - [ ] Há issues de segurança (credenciais, sanitização)?
> - [ ] Há issues de performance (timeouts, paginação)?
