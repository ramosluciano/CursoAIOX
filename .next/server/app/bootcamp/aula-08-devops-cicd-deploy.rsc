...
3:T2b8e,# Aula 08 — DevOps: CI/CD, Observabilidade e Deploy
...
> - [ ] O endpoint /metrics retorna dados no formato Prometheus?
> - [ ] Há métricas de negócio (jogos, perguntas, scores) — não apenas métricas técnicas?
> - [ ] Há métricas de latência da API (histogram com percentis)?
> - [ ] As métricas têm labels úteis (modo de jogo, dificuldade, status)?
...
> **Checklist de avaliação**
> - [ ] Grafana abre sem erro de configuração?
> - [ ] Dashboards estão pré-provisionados (não precisa criar manualmente)?
> - [ ] Datasource do Prometheus está configurado automaticamente?
> - [ ] Após jogar alguns quizzes, os gráficos mostram dados?
...
> - [ ] O CI roda testes com banco real (não apenas mocks)?
> - [ ] O coverage threshold está definido no pipeline?
> - [ ] Há step de build das imagens Docker (garante que Dockerfiles funcionam)?
> - [ ] O deploy é separado do CI (não deploya se testes falharem)?
> - [ ] Há workflow de preview para PRs?
