...
3:T4bf1,# Aula 01 — Setup e Anatomia do AIOX
...
> - [ ] npm v9+ instalado
> - [ ] Git instalado e configurado (`git config user.name` retorna seu nome)
> - [ ] Pelo menos um coding agent CLI instalado
