    ...
    <article className="max-w-4xl mx-auto">
      ...
      <div className="mt-12 flex justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          <button className="px-6 py-3 rounded-lg font-semibold transition-all duration-300 flex items-center gap-2 whitespace-nowrap bg-gray-100 dark:bg-slate-700 text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-slate-600">
